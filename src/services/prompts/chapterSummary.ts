...
export const getFictionChapterSummaryPrompt = (title: string, content: string) => `请为以下章节内容生成一个详细的中文总结：
...
export const getNonFictionChapterSummaryPrompt = (title: string, content: string) => `请为以下社科类书籍章节内容生成一个详细的中文总结：
